...
- [compose.yaml](../../deploy/esphome/docker/compose.yaml) 负责启动本地 `ESPHome Dashboard`
- [secrets.example.yaml](../../deploy/esphome/secrets.example.yaml) 是设备侧 secrets 模板
- [reterminal_e1001_first_flash_alt.yaml](../../deploy/esphome/reterminal_e1001_first_flash_alt.yaml) 首刷配置（`7.50inv2alt`，已验证可亮屏）
- [reterminal_e1001_infohub_api.yaml](../../deploy/esphome/reterminal_e1001_infohub_api.yaml) 业务面板（`7.50inV2p`，支持局部刷新）
- [reterminal_e1001_partial_refresh_probe.yaml](../../deploy/esphome/reterminal_e1001_partial_refresh_probe.yaml) 局部刷新探针（已验证通过）
...
- 当前这台设备优先使用 [reterminal_e1001_first_flash_alt.yaml](../../deploy/esphome/reterminal_e1001_first_flash_alt.yaml)
...
4. 用 [reterminal_e1001_first_flash_alt.yaml](../../deploy/esphome/reterminal_e1001_first_flash_alt.yaml) 生成 `factory` 固件
5. 第一次通过浏览器/USB 刷进设备
...
2. 把设备切到 [reterminal_e1001_infohub_api.yaml](../../deploy/esphome/reterminal_e1001_infohub_api.yaml)
3. 通过 OTA 更新
4. 验证只有 JSON 变化时才刷新
...
- Compose 文件：[compose.yaml](../../deploy/esphome/docker/compose.yaml)
- Docker 环境变量示例：[.env.example](../../deploy/esphome/docker/.env.example)
- 首刷 runbook：[infohub-eink-first-flash-runbook.md](./infohub-eink-first-flash-runbook.md)
- API 直连方案：[infohub-eink-direct-api-panel.md](./infohub-eink-direct-api-panel.md)
